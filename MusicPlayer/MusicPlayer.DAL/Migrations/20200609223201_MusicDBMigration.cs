        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaylistName = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MusicGenres_Music_MusicId",
                        column: x => x.MusicId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserPlaylistId = table.Column<int>(nullable: false),
                    MusicId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MusicPlaylists_Music",
                        column: x => x.MusicId,
                        principalTable: "Music",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MusicPlaylists_UserPlaylists",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Сергій Бабкін", "Музасфера", null, 2018 },
                    { 3, "Один в каное", "Один в каное", null, 2016 },
                    { 4, "Бумбокс", "III", null, 2008 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, null, "Letay", "Ми вільні", null, 2020 },
                    { 5, null, "Мотор'Ролла", "8-Ий колір", null, 2005 },
                    { 8, null, "Letay", "Мила моя", null, 2018 },
                    { 10, null, "Сергій Бабкін", "Дихай повільно", null, 2018 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 1, 2, "Сергій Бабкін", "Де би я", null, 2018 },
                    { 6, 3, "Один в каное", "Човен", null, 2016 },
                    { 9, 3, "Один в каное", "Пообіцяй мені", null, 2016 },
                    { 4, 4, "Бумбокс", "Наодинці", null, 2006 }
                });

            migrationBuilder.InsertData(
                table: "MusicGenres",
                columns: new[] { "Id", "GenreId", "MusicId" },
                values: new object[,]
                {
                    { 2, 1, 2 },
                    { 3, 1, 3 },
            ...
            migrationBuilder.CreateIndex(
                name: "UIX_AlbumTable_Name_Author",
                table: "Albums",
            ...
            migrationBuilder.CreateIndex(
                name: "UIX_Music_Name_Author_Year",
                table: "Music",
                columns: new[] { "Name", "Author", "Year" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "UIX_MusicGenreTable_MusicId_GenreId",
                table: "MusicGenres",
                columns: new[] { "MusicId", "GenreId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "UIX_PlaylistMusic",
                table: "MusicPlaylists",
                columns: new[] { "UserPlaylistId", "MusicId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "UIX_UserPlaylists",
                table: "UserPlaylists",
                columns: new[] { "UserId", "PlaylistName" },
                unique: true,
                filter: "[UserId] IS NOT NULL AND [PlaylistName] IS NOT NULL");
        }
